<script lang="ts" setup>
  import type { IStaffFolder } from "~/types/file.type"
  ...
  const staffInfo = computed(() => {
    ...
    return {
      Surname: folder.value.staff.surname,
      Firstname: folder.value.staff.firstname,
      Lastname: folder.value.staff.lastname || "NOT_SET",
